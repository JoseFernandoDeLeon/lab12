 ...
 * Programa: Contador utilizando un pot con ADC, uso de la EEPROM y el modo sleep habilitado
 * Hardware: pot en PORTA, Pushbutton en PORTB y leds & resistencias en PORTC 
 * 
 * Creado: 16/05/22
 * Última modificación: 16/05/22
 */
